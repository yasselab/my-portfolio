  ...
  return (
    <section className="max-w-7xl mx-auto px-6 lg:px-10 py-16 lg:py-24 grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="space-y-6">
        ...
        <h1
          className="
            font-extrabold text-brand-text leading-tight
            whitespace-nowrap 
            text-[clamp(1.2rem,3.5vw,2rem)]   /* Mobile → petit, Desktop → moyen */
          "
        >
        ...
        {/* 🎯 ELABJANI — très grand + beige + gras */}
        <p
          className="
            font-extrabold text-brand-accent 
            text-[clamp(1.8rem,6vw,3.5rem)]    /* Mobile → grand, Desktop → énorme */
            leading-tight
          "
        >
          ELABJANI Yassmine
        ...
        <div className="flex items-center gap-4 pt-6 ml-20">
          ...
          <a
            ...
            className="h-12 w-12 rounded-full flex items-center justify-center
                       bg-[#FBF8F4] border border-[#E5DDD4] hover:shadow-md transition"
          >
...
//             text-[clamp(1.4rem,4vw,2.4rem)]   /* mobile : s'adapte à la largeur */
//             md:text-5xl lg:text-6xl           /* à partir de md : gros titre normal */
//           "
//         >
//           {words[index].substring(0, subIndex)}
//           <span className="border-r-2 border-brand-accent ml-1 animate-pulse" />
...
//         <p className="text-[17px] font-bold text-brand-accent max-w-xl leading-relaxed">
//   ELABJANI Yassmine
// </p>
